...
<head>
	...
	<!-- Favicon -->
	<link rel="icon" type="image/png" href="<c:url value='/assets/images/favicon.png' />">
	<!-- Web Font -->
	...
	<!-- Slicknav -->
    <link rel="stylesheet" href="<c:url value='/assets/css/slicknav.minl.css' />"> 
...
<body class="js">
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-5 col-md-12 col-12">
						...
						<div class="top-left">
							<ul class="list-main">
								<li><i class="ti-headphone-alt"></i> +<c:out value="${indexpagedata.phoneNumber}"/></li>
								<li><i class="ti-email"></i> <c:out value="${indexpagedata.email}"/></li>
							</ul>
						</div>
						<!--/ End Top Left -->
					</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-2 col-md-2 col-12">
						<!-- Logo -->
						<div class="logo">
							<a href="index.html"><img src="<c:url value='/assets/images/logo.png' />" alt="logo"></a>
	...
	<!-- Color JS -->
	<script src="<c:url value='/assets/js/colors.js' />"></script> 
	<!-- Slicknav JS -->
